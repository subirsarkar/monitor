...
filter="odd"
PROGNAME=$HOME/scripts/convert_RUtoEDM_$filter.sh
...
for path in $(echo /data2:TIB /data2:TOB /data2:TEC /data2:TIBTOB /data2:TIF /data3:TIB /data3:TOB /data3:TIBTOB /data3:TIF)
do
