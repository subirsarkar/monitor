...
our $vo2server = {
        ...
        atlas => [ q|voms.cern.ch|,           1, $nodeList->[1] ],
         argo => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
        babar => [ q|voms.gridpp.ac.uk|,      0, $nodeList->[0] ],
          bio => [ q|voms.cnaf.infn.it|,      1, $nodeList->[0] ],
       biomed => [ q|cclcgvomsli01.in2p3.fr|, 1, $nodeList->[0] ],
#          cms => [ q|voms.cern.ch|,           1, $nodeList->[1] ],
          cms => [ q|lcg-voms.cern.ch|,           1, $nodeList->[1] ],
          cdf => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
    compassit => [ q|voms2.cnaf.infn.it|,     0, $nodeList->[0] ],
     compchem => [ q|voms.cnaf.infn.it|,      1, $nodeList->[0] ],
        dteam => [ q|voms.cern.ch|,           0, $nodeList->[1] ],
        egrid => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
         enea => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
          esr => [ q|voms.grid.sara.nl|,      0, $nodeList->[0] ],
  'glast.org' => [ q|voms2.cnaf.infn.it|,     0, $nodeList->[1] ],
       gridit => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
         inaf => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
     infngrid => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
         ingv => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
         lhcb => [ q|voms.cern.ch|,           1, $nodeList->[1] ],
         libi => [ q|voms.cnaf.infn.it|,      0, $nodeList->[0] ],
     ...
     theophys => [ q|voms.cnaf.infn.it|,      1, $nodeList->[0] ],
        virgo => [ q|voms.cnaf.infn.it|,      1, $nodeList->[0] ],
         zeus => [ q|grid-voms.desy.de|,      0, $nodeList->[0] ]
};
